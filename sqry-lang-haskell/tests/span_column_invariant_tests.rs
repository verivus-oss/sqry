...
fn staged_nodes(source: &str) -> Vec<(String, u32, u32)> {
    ...
    sqry_lang_haskell::relations::HaskellGraphBuilder::default()
...
/// Both `data` and `newtype` mints, placed past line 1.
#[test]
fn data_and_newtype_declarations_keep_columns_inside_their_lines() {
