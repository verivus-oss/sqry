...
- *(release-control)* gate public distribution
## [29.0.2](https://github.com/verivus-oss/sqry/compare/v28.0.3...v29.0.2) - 2026-07-13

### Fixed

- *(core)* silence release-only dead_code on rebuild-plane residue helpers ([#598](https://github.com/verivus-oss/sqry/pull/598))
