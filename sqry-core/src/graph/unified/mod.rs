...
// Transaction API (FR-2025-007 Workstream A)
pub mod txn;

// Query adapter (FR-2025-007 Workstream C)
...
pub use storage::{
    ...
    IndicesStats, InternerStats, NodeArena, NodeEntry, RegistryError, RegistryStats, ResolveError,
    Slot, SlotState, StringInterner,
};
