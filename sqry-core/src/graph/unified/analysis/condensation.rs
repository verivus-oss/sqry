...
pub struct LabelBudgetConfig {
    /// Maximum intervals per edge kind. Default: 50,000,000.
...
impl CondensationDag {
    ...
    pub fn build_with_budget(
        ...
        let budget = budget_config.budget_per_kind;
...
mod tests {
    ...
    fn test_label_budget_default() {
        ...
        assert_eq!(config.budget_per_kind, 50_000_000);
