...
impl Default for BuildConfig {
    fn default() -> Self {
        ...
        let label_budget = LabelBudgetConfig {
            budget_per_kind: std::env::var("SQRY_LABEL_BUDGET")
                .ok()
                .and_then(|v| v.parse::<usize>().ok())
                .unwrap_or(50_000_000),
            on_exceeded: if std::env::var("SQRY_LABEL_BUDGET_FAIL")
                .ok()
                .is_some_and(|v| v == "1" || v.eq_ignore_ascii_case("true"))
            {
                crate::graph::unified::analysis::BudgetExceededPolicy::Fail
            } else {
                crate::graph::unified::analysis::BudgetExceededPolicy::Degrade
            },
        };
...
fn build_unified_graph_inner(
    ...
    for chunk_range in chunks {
        ...
        // Phase 2: Count + range assignment
