...
//! ```
//!
//! # Migration Note (FR-2025-007 Phase 2)
//!
//! This helper is designed to ease migration from legacy `CodeGraph` to `StagingGraph`.
//! It provides a similar high-level API to what plugins used with the legacy graph.
