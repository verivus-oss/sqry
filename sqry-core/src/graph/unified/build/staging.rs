...
//!
//! This module implements the staging buffer (FR-37) that provides
//! transactional semantics for graph builds.
//!
//! # Overview
//!
...
impl StagingGraph {
    ...
    /// Resolve a `NodeEntry`'s display name from staged `InternString` operations.
    ///
