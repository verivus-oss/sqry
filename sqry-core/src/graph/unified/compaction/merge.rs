...
//! # Design (FR-43, FR-44)
//!
//! - **FR-43**: Monotonic sequence numbers enable deterministic ordering
//! - **FR-44**: Last-writer-wins semantics based on highest sequence number
//!
//! # Algorithm
//!
