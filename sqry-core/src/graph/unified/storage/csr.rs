...
impl CsrGraph {
    ...
    /// Validates all CSR invariants (FR-61).
    ///
    ...
    pub fn validate(&self) -> Result<(), CsrError> {
        // FR-61.1: row_ptr length == node_count + 1
        ...
        // FR-61.3: row_ptr[0] == 0 (check before monotonicity to give better error)
        ...
        // FR-61.2: row_ptr monotonically non-decreasing
        ...
        // FR-61.4: row_ptr[last] == col_idx.len()
        ...
        // FR-61.5: col_idx, edge_kind, edge_seq, edge_spans same length
