...
/// CP-5: Single-writer serialization.
///
...
/// CP-5: Operation ordering via atomic sequence.
///
...
/// CP-6: MVCC epoch consistency with snapshot correlation.
///
...
/// CP-6: Concurrent readers during write with epoch correlation.
///
