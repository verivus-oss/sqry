...
/// Error types for LLM tool integration
pub mod errors;

/// Configuration module (buffer sizes, tuning parameters)
pub mod config;

/// JSON response types for LLM tool integration
...
// NOTE: The original FR-2026-001 hybrid embeddings path (embeddings/vector/security
...
// docs/development/FR-2026-001-nl-translation/01_SPEC.md.
