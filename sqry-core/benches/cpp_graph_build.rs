...
fn bench_react_files(c: &mut Criterion) {
    let test_files = vec![
        "/mnt/sqry-test/FR-2025-006-performance/repos/facebook_react/scripts/perf-counters/src/jsc-perf.cpp",
        "/mnt/sqry-test/FR-2025-006-performance/repos/facebook_react/scripts/perf-counters/src/thread-local.cpp",
        "/mnt/sqry-test/FR-2025-006-performance/repos/facebook_react/scripts/perf-counters/src/hardware-counter.cpp",
        "/mnt/sqry-test/FR-2025-006-performance/repos/facebook_react/scripts/perf-counters/src/perf-counters.cpp",
    ];
