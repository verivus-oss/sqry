...
### Other
- *(security)* tighten deny.toml bans + sources policy ([#321](https://github.com/verivus-oss/sqry/pull/321))## [13.0.17](https://github.com/verivus-oss/sqry/compare/v13.0.16...v13.0.17) - 2026-05-09

### Other
- update Cargo.toml dependencies
## [13.0.16](https://github.com/verivus-oss/sqry/compare/v13.0.15...v13.0.16) - 2026-05-09
...
### Documentation
- *(public-issue-triage)* land DOCS unit (Layer 4) for badliveware go-batch- *(public-issue-triage)* add layer3 b1 codex iter3 review## [10.0.1](https://github.com/verivus-oss/sqry/compare/v10.0.0...v10.0.1) - 2026-04-27
...
### Fixed
- *(mcp-redaction)* add depth limit to walker to prevent stack overflow## [7.2.0](https://github.com/verivus-oss/sqry/compare/v7.1.4...v7.2.0) - 2026-04-06
