...
impl RedactionConfig {
    ...
    /// # Use Case
    ///
    /// Cloud LLMs that need to see code context but shouldn't see infrastructure details.
    #[must_use]
    pub fn minimal() -> Self {
        Self {
    ...
    /// Recommended default for cloud LLM integrations.
    ///
    /// # Use Case
    ///
    /// Cloud LLMs where code is confidential but documentation can help understanding.
    #[must_use]
