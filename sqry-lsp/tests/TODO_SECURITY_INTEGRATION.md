...
## Proposed Solution (for FR-2025-008 or later)
...
- Integration testing deferred to when it's needed (FR-2025-008)

**For FR-2025-008 (security enhancements)**: Implement Option 1 (direct function testing)
...
- [ ] Add proper integration tests in FR-2025-008 (security enhancements)
- [ ] Consider making `security` module public for easier testing
- [ ] Add this TODO to FR-2025-008 SPEC as acceptance criteria
