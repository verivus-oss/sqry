...
- *(lsp)* stop advertising client-owned sqry.index in executeCommandProvider ([#633](https://github.com/verivus-oss/sqry/pull/633))
## [29.0.5](https://github.com/verivus-oss/sqry/compare/v29.0.4...v29.0.5) - 2026-07-18
...
- *(lsp)* serialize test-delay unit tests to fix flaky global-state race ([#588](https://github.com/verivus-oss/sqry/pull/588))
...
### Other
- update Cargo.lock dependencies
## [26.0.3](https://github.com/verivus-oss/sqry/compare/v26.0.2...v26.0.3) - 2026-07-03
...
### Other
- update Cargo.lock dependencies
## [24.0.1](https://github.com/verivus-oss/sqry/compare/v24.0.0...v24.0.1) - 2026-06-29
...
### Other
- *(deps)* bump dashmap to 6.2.1 ([#334](https://github.com/verivus-oss/sqry/pull/334))- *(security)* tighten deny.toml bans + sources policy ([#321](https://github.com/verivus-oss/sqry/pull/321))## [16.0.7](https://github.com/verivus-oss/sqry/compare/v16.0.6...v16.0.7) - 2026-05-31

### Other
- *(deps)* bump dashmap to 6.2.1 ([#334](https://github.com/verivus-oss/sqry/pull/334))## [16.0.6](https://github.com/verivus-oss/sqry/compare/v16.0.5...v16.0.6) - 2026-05-20
...
### Other
- update Cargo.lock dependencies
## [14.0.2](https://github.com/verivus-oss/sqry/compare/v14.0.1...v14.0.2) - 2026-05-10

### Other
- update Cargo.lock dependencies
## [14.0.1](https://github.com/verivus-oss/sqry/compare/v14.0.0...v14.0.1) - 2026-05-09
...
### Other
- update Cargo.toml dependencies
## [12.0.1](https://github.com/verivus-oss/sqry/compare/v11.0.4...v12.0.1) - 2026-05-03

### Fixed
- *(lsp)* make single-root graph routing explicit## [12.0.0](https://github.com/verivus-oss/sqry/compare/v11.0.4...v12.0.0) - 2026-05-02
...
### Fixed
- *(nl)* tighten ort dylib detection and gate LSP map_error test seam behind feature- *(nl)* hoist Translator init off tokio worker; tighten LSP perf test; warn on LSP config drift- *(nl)* replace placeholder NL07 tests with real harnesses; use scopeguard for pool panic-safety## [11.0.4](https://github.com/verivus-oss/sqry/compare/v11.0.3...v11.0.4) - 2026-05-01
...
### Fixed
- *(vscode)* stabilize lsp indexing## [9.0.19](https://github.com/verivus-oss/sqry/compare/v9.0.18...v9.0.19) - 2026-04-25
