...
- *(cli)* index status reports languages; --add-to-gitignore writes .sqry/ ([#617](https://github.com/verivus-oss/sqry/pull/617))
...
- *(index)* wire --cfg and --expand-cache into Rust macro-boundary analysis (post-#567) ([#574](https://github.com/verivus-oss/sqry/pull/574))

### Fixed

- *(cli)* remove unplumbed macro-expansion flags from `sqry index` ([#569](https://github.com/verivus-oss/sqry/pull/569))
...
### Other
- update Cargo.lock dependencies
## [27.0.0](https://github.com/verivus-oss/sqry/compare/v26.0.1...v27.0.0) - 2026-07-03

### Changed
- *(cli)* remove dead daemon auto-start plumbing ([#490](https://github.com/verivus-oss/sqry/pull/490))## [26.0.3](https://github.com/verivus-oss/sqry/compare/v26.0.2...v26.0.3) - 2026-07-03
...
### Fixed
- *(session)* harden graph cache semantics- *(session)* use session graph cache for queries- *(graph)* clarify detailed stats and sync 25.0.2 metadata## [25.0.2](https://github.com/verivus-oss/sqry/compare/v25.0.1...v25.0.2) - 2026-06-30
...
### Fixed
- *(release)* verify published artifact attestations## [20.0.5](https://github.com/verivus-oss/sqry/compare/v20.0.4...v20.0.5) - 2026-06-12
...
### Performance
- *(c-icall-precision)* speed up Pass 5b kernel indexing ([#289](https://github.com/verivus-oss/sqry/pull/289))## [16.0.6](https://github.com/verivus-oss/sqry/compare/v16.0.5...v16.0.6) - 2026-05-20
...
### Performance
- *(c-icall-precision)* speed up Pass 5b kernel indexing ([#289](https://github.com/verivus-oss/sqry/pull/289))## [16.0.2](https://github.com/verivus-oss/sqry/compare/v16.0.1...v16.0.2) - 2026-05-19
...
### Added
- *(go)* Go implicit implements + promoted methods + function-signature implementations (T1) ([#277](https://github.com/verivus-oss/sqry/pull/277))## [15.0.7](https://github.com/verivus-oss/sqry/compare/v15.0.6...v15.0.7) - 2026-05-13
