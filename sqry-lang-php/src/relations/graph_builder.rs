...
/// - FFI::cdef("...", "lib.so") - positional (second arg)
/// - FFI::cdef(lib: "lib.so", cdef: "...") - named (lib arg)
/// - FFI::load("header.h") - positional (first arg)
/// - FFI::load(filename: "header.h") - named (filename arg)
...
///
/// Returns None if the argument is not a valid string literal (e.g., variable, constant,
...
/// - "{$arr['key']}" - array access (complex)
/// - "{$obj->prop}" - property access (complex)
///
...
/// - Function calls: $foo() (may contain variables)
/// - Static access: $Class::$prop, $Class::method() (may contain variables)
/// - Class constants: $Class::CONST (may have dynamic class name)
