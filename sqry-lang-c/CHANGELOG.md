...
- *(perf-gate)* same-commit marginal Phase A build-time gate ([#280](https://github.com/verivus-oss/sqry/pull/280)) ([#531](https://github.com/verivus-oss/sqry/pull/531))
...
### Fixed
- *(release)* allowlist v16.0.7 baseline drift
### Performance
- *(lang-c)* fuse Phase A per-file AST walks; single-pass C scope index ([#351](https://github.com/verivus-oss/sqry/pull/351))## [18.0.3](https://github.com/verivus-oss/sqry/compare/v18.0.2...v18.0.3) - 2026-06-02

### Performance
- *(lang-c)* fuse Phase A per-file AST walks; single-pass C scope index ([#351](https://github.com/verivus-oss/sqry/pull/351))## [16.0.8](https://github.com/verivus-oss/sqry/compare/v16.0.6...v16.0.8) - 2026-05-31

### Other
- *(security)* tighten deny.toml bans + sources policy ([#321](https://github.com/verivus-oss/sqry/pull/321))## [16.0.2](https://github.com/verivus-oss/sqry/compare/v16.0.1...v16.0.2) - 2026-05-19
