...
### Fixed
- *(cpp)* emit nested C++ type nodes
### Other
- *(security)* tighten deny.toml bans + sources policy ([#321](https://github.com/verivus-oss/sqry/pull/321))## [16.0.7](https://github.com/verivus-oss/sqry/compare/v16.0.6...v16.0.7) - 2026-05-30

### Fixed
- *(cpp)* emit nested C++ type nodes## [15.0.3](https://github.com/verivus-oss/sqry/compare/v15.0.2...v15.0.3) - 2026-05-13
