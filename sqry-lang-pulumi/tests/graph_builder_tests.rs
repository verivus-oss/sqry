...
use common::{build_staging_graph_from_fixture, has_display_node, has_edge_between, has_node};
...
fn test_pulumi_yaml_graph_edges() {
    ...
    assert!(has_display_node(&staging, "resources.net"));
    assert!(has_display_node(&staging, "package.aws"));
