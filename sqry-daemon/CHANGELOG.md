...
- *(daemon)* compact edges (delta -> CSR) on cold-load so per-node graph tools are O(1) ([#629](https://github.com/verivus-oss/sqry/pull/629))
...
- *(daemon)* reject non-absolute MCP workspace paths instead of resolving against $HOME ([#568](https://github.com/verivus-oss/sqry/pull/568))
...
## [27.0.7](https://github.com/verivus-oss/sqry/compare/v27.0.5...v27.0.7) - 2026-07-05

### Added
- *(daemon)* bounded CpuExecutor + read-path cancellation ([#503](https://github.com/verivus-oss/sqry/pull/503))## [27.0.6](https://github.com/verivus-oss/sqry/compare/v27.0.5...v27.0.6) - 2026-07-04
...
### Fixed
- *(security)* resolve code-scanning alerts across webview and logging## [25.0.2](https://github.com/verivus-oss/sqry/compare/v25.0.1...v25.0.2) - 2026-06-30
...
### Other
- update Cargo.lock dependencies
## [23.1.0](https://github.com/verivus-oss/sqry/compare/v23.0.2...v23.1.0) - 2026-06-27

### Other
- update Cargo.lock dependencies
## [23.0.2](https://github.com/verivus-oss/sqry/compare/v23.0.1...v23.0.2) - 2026-06-27
...
### Fixed
- *(daemon)* stop pinned-preload derived-cache hook pegging Tokio workers ([#439](https://github.com/verivus-oss/sqry/pull/439))## [23.0.0](https://github.com/verivus-oss/sqry/compare/v22.0.4...v23.0.0) - 2026-06-27
...
### Other
- update Cargo.lock dependencies
## [22.0.3](https://github.com/verivus-oss/sqry/compare/v22.0.2...v22.0.3) - 2026-06-25

### Other
- update Cargo.lock dependencies
## [22.0.2](https://github.com/verivus-oss/sqry/compare/v22.0.1...v22.0.2) - 2026-06-25

### Other
- update Cargo.lock dependencies
## [22.0.1](https://github.com/verivus-oss/sqry/compare/v22.0.0...v22.0.1) - 2026-06-25
...
### Other
- update Cargo.lock dependencies
## [20.0.10](https://github.com/verivus-oss/sqry/compare/v20.0.9...v20.0.10) - 2026-06-14

### Other
- update Cargo.lock dependencies
## [20.0.9](https://github.com/verivus-oss/sqry/compare/v20.0.8...v20.0.9) - 2026-06-14
...
### Fixed
- *(release)* repair public docs and macos daemon build## [20.0.1](https://github.com/verivus-oss/sqry/compare/v20.0.0...v20.0.1) - 2026-06-12
...
### Other
- update Cargo.lock dependencies
## [18.0.7](https://github.com/verivus-oss/sqry/compare/v18.0.5...v18.0.7) - 2026-06-02

### Fixed
- *(daemon)* key derived-cache save on actual snapshot SHA, not manifest ([#361](https://github.com/verivus-oss/sqry/pull/361))## [18.0.6](https://github.com/verivus-oss/sqry/compare/v18.0.5...v18.0.6) - 2026-06-02

### Fixed
- *(daemon)* write derived cache on rebuild and decouple its save timeout ([#360](https://github.com/verivus-oss/sqry/pull/360))## [18.0.5](https://github.com/verivus-oss/sqry/compare/v18.0.4...v18.0.5) - 2026-06-02
...
### Other
- update Cargo.lock dependencies
## [17.0.1](https://github.com/verivus-oss/sqry/compare/v17.0.0...v17.0.1) - 2026-05-31

### Fixed
- *(security)* remediate v17 Dependabot alerts## [17.0.0](https://github.com/verivus-oss/sqry/compare/v16.0.8...v17.0.0) - 2026-05-31
...
### Added
- *(nl)* surface ONNX Runtime missing as actionable platform hint across CLI/MCP/LSP/daemon- *(nl)* classifier pool + daemon sqry_ask tool + LSP wiring + perf bounds- *(nl)* add 5-level model_dir resolver and wire --model-dir override
### Fixed
- *(nl)* harden classifier trust and daemon config- *(nl)* hoist Translator init off tokio worker; tighten LSP perf test; warn on LSP config drift- *(nl)* replace placeholder NL07 tests with real harnesses; use scopeguard for pool panic-safety## [11.0.4](https://github.com/verivus-oss/sqry/compare/v11.0.3...v11.0.4) - 2026-05-01
...
### Other
- update Cargo.lock dependencies
## [10.0.4](https://github.com/verivus-oss/sqry/compare/v10.0.3...v10.0.4) - 2026-04-28
...
### Other
- update Cargo.lock dependencies
## [9.0.21](https://github.com/verivus-oss/sqry/compare/v9.0.20...v9.0.21) - 2026-04-26
...
### Fixed
- *(daemon)* support non-Linux Unix self-pipe creation## [9.0.16](https://github.com/verivus-oss/sqry/compare/v9.0.15...v9.0.16) - 2026-04-25
...
### Other
- update Cargo.lock dependencies
## [9.0.8](https://github.com/verivus-oss/sqry/compare/v9.0.6...v9.0.8) - 2026-04-24

### Fixed
- *(daemon)* unify notify socket test guard## [9.0.7](https://github.com/verivus-oss/sqry/compare/v9.0.6...v9.0.7) - 2026-04-24
...
### Fixed
- *(daemon)* format cancel rebuild test- *(daemon)* prevent cancel_rebuild from poisoning subsequent rebuilds and fix stale rebuild stats## [9.0.5](https://github.com/verivus-oss/sqry/compare/v9.0.4...v9.0.5) - 2026-04-24
...
- *(mcp)* add find_duplicates per-group member cap wire output and schema (DUP_2)
### Fixed
- *(daemon)* format cancel rebuild test- *(daemon)* prevent cancel_rebuild from poisoning subsequent rebuilds and fix stale rebuild stats## [9.0.1](https://github.com/verivus-oss/sqry/compare/v9.0.0...v9.0.1) - 2026-04-23

### Added
- *(mcp)* add find_duplicates per-group member cap wire output and schema (DUP_2)
### Fixed
- *(daemon)* format cancel rebuild test- *(daemon)* prevent cancel_rebuild from poisoning subsequent rebuilds and fix stale rebuild stats## [9.0.0](https://github.com/verivus-oss/sqry/releases/tag/v9.0.0) - 2026-04-23

### Added
- *(mcp)* add daemon workspace mutual exclusion check in ensure_graph (MUTEX_1)
### Fixed
- *(daemon)* format cancel rebuild test- *(daemon)* prevent cancel_rebuild from poisoning subsequent rebuilds and fix stale rebuild stats