...
//!
//! This module centralizes the registration of all 37 language plugins to ensure
...
mod tests {
    ...
    fn test_create_plugin_manager_has_all_plugins() {
        ...
        // Should have 37 plugins (28 general-purpose + 5 domain-specific + 3 IaC + 1 config)
        assert_eq!(
            plugins.len(),
            37,
