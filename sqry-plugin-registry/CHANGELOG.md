...
### Other
- *(security)* tighten deny.toml bans + sources policy ([#321](https://github.com/verivus-oss/sqry/pull/321))## [14.0.2](https://github.com/verivus-oss/sqry/compare/v13.0.17...v14.0.2) - 2026-05-10
...
### Added
- *(cli)* add plugin cost tiering and manifest-backed selection
### Documentation
