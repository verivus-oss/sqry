...
|---------|------|---------|
| 31.0.0 | 2026-06-25 | Document the body-shape descriptor types + snapshot V15 (`ShapeDescriptor`, `CfBucket`, `SHAPE_SCHEMA_VERSION`) |
| 31.0.0 | 2026-03-10 | Bump schema doc version to match current sqry release |
