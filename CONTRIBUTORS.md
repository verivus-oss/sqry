...
1. **Report Bugs**: Open an issue on [GitHub Issues](https://github.com/verivusai-open/sqry/issues)
2. **Suggest Features**: Start a discussion in [GitHub Discussions](https://github.com/verivusai-open/sqry/discussions)
...
2. **Set Up Development Environment**
   ...
   git clone https://github.com/verivusai-open/sqry.git
   cd sqry
...
- **General Questions**: Open a [GitHub Discussion](https://github.com/verivusai-open/sqry/discussions)
- **Bug Reports**: Open a [GitHub Issue](https://github.com/verivusai-open/sqry/issues)
- **Security Issues**: Email hello@sqry.dev directly
- **Feature Requests**: Start a [Discussion](https://github.com/verivusai-open/sqry/discussions) first
