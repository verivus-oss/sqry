...
5. **Add Language Support**: Implement a new language plugin (see [Plugin Architecture Guide](docs/PLUGIN_ARCHITECTURE.md))
...
Help us expand language support! Current language plugins:

**Tier 1 (Full Support)**:
- Rust, Python, TypeScript, JavaScript, Go, Java

**Tier 2**:
- C, C++, C#, Dart, Kotlin, Lua, R, Ruby, Scala, Swift, Groovy, Svelte

**Tier 3 (Specialized)**:
- PHP, SQL, Shell/Bash, YAML, Terraform, Puppet, Xanadu platform

**Future/Preview**:
- HTML, CSS, Haskell, Perl, Elixir, Vue

Want to add a language? See our [Plugin Development Guide](docs/PLUGIN_ARCHITECTURE.md).
...
- **[ripgrep](https://github.com/BurntSushi/ripgrep)** - Fast text search (hybrid mode)
...
1. **Language Plugins**
   - Complete Svelte plugin (SFC queries, scopes, relations)
   - Complete Groovy plugin (relation tracking)
   - Add new languages from [expansion roadmap](docs/development/FR-2025-003_EXPAND_LANGUAGE_COVERAGE.md)

2. **Performance Optimization**
   - Implement query optimizer (predicate pushdown)
   - Improve ranking algorithm
   - Optimize hybrid search classifier

3. **MCP Tools**
   - Add 2 remaining AI workflow tools
...
1. **VSCode Extension**
   - Complete integration test suite (15 TODOs)
   - Add unit tests
...
*Last updated: February 2026 (v4.5.9)*
