...
fn process(data: []const u8) void {
    std.debug.print("Data: {any}\n", .{data});
        ...
        // Verify qualified call to std.debug.print
...
fn main() void {
    ...
    list.append(42);
        ...
        assert_has_node_with_kind(&staging, "ArrayList.append", NodeKind::Function);

        // Verify main function exists
        assert_has_node_with_kind(&staging, "main", NodeKind::Function);

        // Verify call edge from main to list.append (qualified call)
...
fn copyData(dest: []u8, src: []const u8) void {
    std.mem.copy(u8, dest, src);
        ...
        // Verify qualified call to std.mem.copy
...
fn main() void {
    ...
    map.deinit();
        ...
        assert_has_node_with_kind(&staging, "ArrayList.init", NodeKind::Function);
        assert_has_node_with_kind(&staging, "ArrayList.deinit", NodeKind::Function);
        assert_has_node_with_kind(&staging, "ArrayList.append", NodeKind::Function);
        assert_has_node_with_kind(&staging, "HashMap.init", NodeKind::Function);
        assert_has_node_with_kind(&staging, "HashMap.deinit", NodeKind::Function);
        assert_has_node_with_kind(&staging, "main", NodeKind::Function);
...
fn main() void {
    ...
    list.deinit();  // This should resolve to ArrayList.deinit, not list.deinit
        ...
        // Verify calls (list.deinit appears as a qualified call in AST)
...
fn main() void {
    std.debug.print("Hello\n", .{});
        ...
        assert_has_node_with_kind(&staging, "other.zig", NodeKind::Import);
        assert_has_import_edge(&staging, FILE_MODULE_NAME, "std");
...
fn loadModule() void {
    ...
    module.init();
        ...
        assert_has_node_with_kind(&staging, "dynamic.zig", NodeKind::Import);
