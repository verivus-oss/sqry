...
use crate::relations::java_common::{PackageResolver, build_member_symbol};
...
fn handle_type_declaration(
    ...
    let qualified_name = qualify_class_name(&class_name, package.as_deref());
...
fn qualify_class_name(class_name: &str, package: Option<&str>) -> String {
