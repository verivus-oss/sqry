...
///
/// Returns a vector of Kotlin type names (e.g., ["Int", "String", "Double"]).
...
///
/// Kotlin uses name mangling for inline value classes (like UInt, ULong) to avoid
...
"#;
        ...
        // Verify the source node is a Method, not a Function
        let nodes: Vec<_> = staging.nodes().collect();
        ...
        assert!(
            ...
            "Expected external method to be NodeKind::Method with exact qualified name"
        );
