...
const GITHUB_RELEASE_BASE = "https://github.com/verivusai-open/sqry/releases/download";
const OIDC_ISSUER = "https://token.actions.githubusercontent.com";
const CERT_IDENTITY_PATTERN = "https://github.com/verivusai-open/sqry/.github/workflows/oss-release.yml@refs/tags/v";
