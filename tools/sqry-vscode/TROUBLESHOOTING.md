...
4. **Clear extension cache**:
   ```bash
   # Linux/Mac
   rm -rf ~/.vscode/extensions/verivuslabs.sqry-vscode-*

   # Windows
   rmdir /s %USERPROFILE%\.vscode\extensions\verivuslabs.sqry-vscode-*
   ```
...
1. **Check sqry version**:
   ```bash
   sqry --version
   # Extension version 2.6.1+ required for progress indicators
   ```
...
**Note**: sqry extension uses sqry CLI, not LSP. For LSP features, see:
- `docs/guides/LSP_SERVER_GUIDE.md`
...
- **Examples**: See `docs/guides/EXAMPLES.md`
