...
# Verify installation
sqry --version
# Should output: sqry 3.1.0 (or later)
```
...
- **Index Status**: symbol/file counts, build age, and health
- **Duplicates**: grouped duplicate symbols (body/signature/struct)
- **Circular Dependencies**: call/import cycles
- **Unused Symbols**: reachability-based dead code
- **Cross-Language Relations**: imports/calls crossing language boundaries
...
- **LSP Guide**: `docs/guides/LSP_SERVER_GUIDE.md`
- **Query Examples**: `docs/guides/EXAMPLES.md`
