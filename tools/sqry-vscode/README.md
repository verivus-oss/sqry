...
1. **Install sqry CLI** (prerequisite):
   ...
   sqry --version  # Verify: 4.8.5+
   ```

2. **Install extension** from VSIX:
   ```bash
   code --install-extension sqry-vscode-4.8.5.vsix
   ```
...
- sqry CLI version 4.8.5 or later
...
# Produces: sqry-vscode-4.8.5.vsix
```
