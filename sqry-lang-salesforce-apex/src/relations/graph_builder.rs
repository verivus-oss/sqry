...
/// Extract the base type name from a type node (handles type_identifier and generic_type).
...
/// Extract Database class method calls (Database.query, Database.insert, etc.)
...
/// Extract sObject name from Database class method arguments
...
/// Extract sObject name from a SOQL query string
...
";
        ...
        // Find call edges from process to MyService.doWork
        let node_names =
            sqry_core::graph::unified::build::test_helpers::build_node_name_lookup(&staging);
...
";
        ...
        // Calls from run should target Inner.doWork, NOT Outer.doWork
