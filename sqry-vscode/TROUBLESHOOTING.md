...
For shared CLI workspace semantics, see
...
2. **Check sqry CLI**:
   ```bash
   sqry --version
   # Should output: sqry 19.0.7 or later
   ```
...
1. **Check sqry version**:
   ```bash
   sqry --version
   # Extension version 19.0.7+ required for progress indicators
   ```
