...
Standalone mode currently lists 39 tools. Daemon-hosted MCP currently exposes a 17-tool subset. If the count differs, trust the live output (`sqry-mcp --list-tools`, `tools/list`, or `sqry://meta/manifest`) and update local docs or client expectations.
