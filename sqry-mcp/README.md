...
**Memory usage estimate**: ~10-15MB per cached workspace engine. Default settings (5 workspaces) use approximately 50-75MB total.
...
echo '{"jsonrpc":"2.0","method":"tools/list","params":{},"id":1}' | cargo run -q -p sqry-mcp
```
...
**Version**: 4.5.3
**Tested With**: sqry v4.5.3, Claude Desktop, Windsurf, Claude Code, Codex, Gemini CLI
