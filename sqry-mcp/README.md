...
> **Removed in 23.0.1:** the `sqry_ask` natural-language MCP tool was removed. Use `sqry_query`, `semantic_search`, and `relation_query` instead; see [Removed features](../docs/TROUBLESHOOTING.md#removed-features) for migration.
