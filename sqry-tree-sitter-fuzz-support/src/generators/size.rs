...
mod tests {
    ...
    #[test]
    fn test_kotlin_uses_kotlin_native_oversized_pattern() {
        let pattern = get_pattern_for_language("kotlin");
        assert_eq!(pattern, "class C { fun m() {} }\n");
        assert!(!pattern.contains("void"));
    }
