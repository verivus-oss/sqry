...
- **P1-14 Security Audit**: All critical and high-priority security issues resolved
  ...
  - Complete audit trail in (internal docs removed)
...
- [FR-2025-007 Unified Graph Architecture]
- [v2.0.0 Removal Plan] - Complete technical specification
...
# Report at: https://github.com/verivus/sqry/issues
...
- **Zig Language Plugin** 🚀 **NEW LANGUAGE SUPPORT**
  ...
  - See [Zig plugin documentation] for implementation details
...
- **Tree-Sitter Incremental Parsing** ⚡ **PERFORMANCE** (FR-2025-006-phase4)
  ...
  - See [FR-2025-006-phase4 documentation] for implementation details and benchmark results
...
- **Unified Graph Architecture** 🎯 **MAJOR FEATURE** (FR-2025-007)
  ...
  - See [FR-2025-007 documentation] for complete architecture and implementation details
- **Multi-Repo Workspace Index** 🏢 **NEW**
  ...
  - See [Multi-Repo Implementation] for complete design and implementation details
- **Query Lexer Buffer Pooling** (FR-2025-005 Phase 2) ⚡
  ...
  - See [FR-2025-005 documentation] for design and benchmarks
...
- **VS Code Extension v0.0.6** - Marketplace-ready release with configurable timeouts
  ...
  - See [VS Code Extension CHANGELOG](tools/sqry-vscode/CHANGELOG.md) for details
...
- **LSP Standard Handlers** (FR-2025-004 Phase 2) ✅ **COMPLETE**
  ...
  - See [LSP Phase 2 Progress] for implementation details
...
- **Advanced IDE Integration planning** (FR-2025-004) 📋 **PLANNING COMPLETE**
  ...
  - See [Enhancement Plan] for full details
...
- **Multi-language relation queries** (FR-2025-001) ✅ **COMPLETE**
  ...
  - See [FR-2025-001] for full implementation details
...
- **Haskell language support** (FR-2025-003) ✅
  ...
  - See [Haskell Implementation] for architecture details
...
- **Vue, Svelte, and Groovy language plugins with first-party tree-sitter bindings** (FR-2025-003) ✅
  ...
  - See [tree-sitter-bindings documentation] for maintenance details
...
- **Relations-Shared Rollout - Step 6: Long-Tail Languages** (94% milestone)
  ...
  - See [STEP_6_RELEASE_NOTES.md] for full details
...
- **VSCode extension preview**: Early access extension (`tools/sqry-vscode/`) delivering semantic query/search commands, dedicated results panel, CodeLens caller counts, auto-index prompts, and configurable CLI settings ahead of Marketplace release.
...
- **[HYBRID_SEARCH_PERFORMANCE.md]**: Performance analysis
  - Detailed benchmark results
  - Optimization opportunities
  - Comparison to targets
  - Methodology and reproducibility
- **[FR-2025-002_WEEK3_COMPLETION_REPORT.md]**: Implementation summary
...
- **Testing Infrastructure**: Verbose test logging system (**NEW** - 2025-10-11)
  ...
  - Full documentation: (internal docs removed)
...
- **Documentation**: Comprehensive cache user guide ([docs/guides/CACHE.md](docs/guides/CACHE.md))
  ...
  - FAQ section
- **Documentation**: Technical cache architecture document ((internal docs removed))
...
- **Regex Security Documentation**: Security rating remains at 9.0/10 (no change)
  ...
  - See [CRGREP_RUST_COMPARISON.md] for detailed analysis
...
- Plugin Development Guide: (internal docs removed)
- Phase 3 Completion: (internal docs removed) (pending)
